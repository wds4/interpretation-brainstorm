...
/*
to access:
http://localhost:3000/api/tests/addDog?name=fido
https://interpretation-brainstorm.vercel.app/api/tests/addDog?name=fido
*/
    ...
    if (typeof name1 == 'string') {
      ...
      try {
        ...
        if (result_exists.rows[0].exists == true) {
          ...
          res.status(200).json({ message: `name ${name1} inserted into the interpretation engine dog database` })
        }
